document.addEventListener("DOMContentLoaded", () =>
                ...
                driverDetails += `
                    <div class="driver-entry ${driverInfo.Name.toLowerCase().includes('studio') ? 'studio-driver' : ''} ${index === 0 ? 'current-driver' : ''}" style="${driverInfo.Name.toLowerCase().includes('studio') ? 'display:none;' : ''}">
                        ...
                        <div class="driver-actions">
                            <a class="view-details" onclick="openModal('${encodeURIComponent(driverInfo.BannerURLGfe)}', '${driverInfo.ReleaseNotes}')">Info Modal</a>
    ...
    function openModal(bannerURLGfe, releaseNotes)
    {
